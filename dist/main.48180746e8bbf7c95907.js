  ...
  return new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
    ...
    mutations: {
      setItem(state, { id, item }) {
        console.log(item);
        __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].set(state.items, id, item.status === 200 ? item.data.data : item.data.message);
      }
    }
  });
}
...
//# sourceMappingURL=main.48180746e8bbf7c95907.js.map